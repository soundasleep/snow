...
describe('vouchers', function() {
    describe('create', function() {
        it('returns voucher code', function(done) {
            ...
            , impersonate = mock.impersonate(app, { id: userId, securityLevel: 2 }, null, { canWithdraw: true })
    ...
    describe('redeem', function() {
        it('redeems', function(done) {
            ...
            , impersonate = mock.impersonate(app, { id: userId, securityLevel: 2 }, null, { canDeposit: true })
